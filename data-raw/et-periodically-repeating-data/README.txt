...
1. Request Parameters
   ------------------
Name: ET and GPP Periodically Repeating Data
Date Completed: 2019-01-04T19:50:41.221333
Id: 9481c5b1-0b58-4f7d-8245-76d5334cd9af
Details:
  ...
  Layers:
      ...
      LE_500m (MYD16A2.006)
      PET_500m (MYD16A2.006)
      PLE_500m (MYD16A2.006)
      ET_500m (MOD16A2.006)
      ET_QC_500m (MOD16A2.006)
      LE_500m (MOD16A2.006)
      PET_500m (MOD16A2.006)
      PLE_500m (MOD16A2.006)
  Coordinates:
...
ET-and-GPP-Periodically-Repeating-Data-MOD16A2-006-results.csv
  Comma-separated values file with data extracted for a specific product

ET-and-GPP-Periodically-Repeating-Data-MYD16A2-006-results.csv
  Comma-separated values file with data extracted for a specific product

ET-and-GPP-Periodically-Repeating-Data-granule-list.txt
  Text file with data pool URLs for all source granules used in the extraction

ET-and-GPP-Periodically-Repeating-Data-request.json
  JSON request file which can be used in AppEEARS to create a new request

ET-and-GPP-Periodically-Repeating-Data-MOD16A2-006-metadata.xml
  xml file

ET-and-GPP-Periodically-Repeating-Data-MYD16A2-006-metadata.xml
  xml file
...
8. Data Product Citations
   ----------------------
 Running, S., Mu, Q., Zhao, M. (2017). MOD16A2 MODIS/Terra Net Evapotranspiration 8-Day L4 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. doi: 10.5067/MODIS/MOD16A2.006. Accessed January 4, 2019.
...
9. Software Citation
   -----------------
 AppEEARS Team. (2018). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.14.2. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed January 4, 2019. https://lpdaacsvc.cr.usgs.gov/appeears
